...
$pdf->AddPage();
$pdf->SetTitle('Cetak - Surat Keterangan Belum Bekerja');
$pdf->SetSubject('Surat Keterangan Belum Bekerja');
...
$pdf->setY(40);
$pdf->setX(22);
$pdf->Cell(0, 6, 'SURAT KETERANGAN BIAYA PENGUBURAN', 0, 1, 'C');
$pdf->AddFont('Calreg', '', 'calreg.php');
$pdf->SetFont('Calreg', '', 12);
$pdf->setY(45);
$pdf->setX(22);
$pdf->Cell(0, 6, 'NOMOR  : 145/1069 - Kel/2020', 0, 1, 'C');
$pdf->SetFont('Calreg', '', 12);
$pdf->setY(55);
$pdf->setX(30);
...
foreach ($sk_bp as $surat) {
    ...
    $pdf->setX(30);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'Adalah   benar   warga   kami   dan  berdasarkan  Keterangan   dari Ketua     RT/RW, serta pertimbangan kami', 0, 1, 'L');
    $pdf->setY(139);
    $pdf->setX(9);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'bahwa yang bersangkutan benar telah meninggal dunia pada hari S', 0, 1, 'L');
    $pdf->setY(147);
    $pdf->setX(30);
    $pdf->SetFont('Calreg', '', 12);
