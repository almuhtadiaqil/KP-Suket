...
$pdf->setY(40);
$pdf->setX(22);
$pdf->Cell(0, 6, 'SURAT KETERANGAN BELUM MENIKAH', 0, 1, 'C');
...
foreach ($sk_belummenikah as $surat) {
    ...
    $pdf->setX(30);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'Adalah   benar   warga   kami   dan  berdasarkan  Keterangan   dari Ketua     RT/RW   bahwa   yang  ', 0, 1, 'L');
    $pdf->setY(139);
    $pdf->setX(9);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'bersangkutan benar sampai saat ini belum menikah.', 0, 1, 'L');
    $pdf->setY(147);
    $pdf->setX(30);
    $pdf->SetFont('Calreg', '', 12);
