...
$pdf->AddPage();
$pdf->SetTitle('Cetak - Surat Keterangan Kehilangan');
$pdf->SetSubject('Surat Keterangan Kehilangan');
...
$pdf->setY(40);
$pdf->setX(22);
$pdf->Cell(0, 6, 'SURAT KETERANGAN KEHILANGAN', 0, 1, 'C');
...
// // Isi Tabel
foreach ($sk_kehilangan as $surat) {
    $pdf->SetFont('Calreg', '', 12);
    $pdf->setY(73);
    $pdf->setX(30);
    ...
    $pdf->setX(30);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'Adalah warga kami dan berdasarkan Keterangan dari Ketua RT/RW  bahwa yang bersangkutan benar ', 0, 1, 'L');
    $pdf->setY(139);
    $pdf->setX(9);
    $pdf->SetFont('Calreg', '', 12);
    $pdf->Cell(0, 6, 'benar telah kehilangan ' . $surat->barang_hilang . ' dengan No ' . $surat->no_seri . ' Atas nama', 0, 1, 'L');
    $pdf->setY(139);
    $pdf->setX(115);
    $pdf->SetFont('Calbold', '', 12);
