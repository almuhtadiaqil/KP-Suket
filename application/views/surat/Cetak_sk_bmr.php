...
$pdf->AddPage();
$pdf->SetTitle('Cetak - Surat Keterangan Belum Belum Memiliki Rumah');
$pdf->SetSubject('Surat Keterangan Belum Belum Memiliki Rumah');
...
$pdf->setY(40);
$pdf->setX(22);
$pdf->Cell(0, 6, 'SURAT KETERANGAN BELUM MEMILIKI RUMAH', 0, 1, 'C');
