                        ...
                        <tbody>
                            ...
                            foreach ($surat_sku as $surat_sku) : ?>
                                <tr>
                                    ...
                                    <th scope="col" value="<?= $surat_sku['status_surat']; ?>"><span class="label label-<?= ($surat_sku['status_surat'] == 'Diterima') ? 'success' : (($surat_sku['status_surat'] == 'Ditolak' || $surat_sku['status_surat'] == 'Dibatalkan') ? 'danger' : 'warning') ?>">
