...
if ($rows['status'] == 'admin') {
  echo "<input type='radio' name='e' value='admin' checked> Admin &nbsp; <input type='radio' name='e' value='user'> User";
} else {
  echo "<input type='radio' name='e' value='admin'> Admin &nbsp; <input type='radio' name='e' value='user' checked> User";
}
echo "</td></tr>
                  </tbody>
                  </table>
              ...
              <div class='box-footer'>
                    ...
                    <a href='" . base_url('administrator/modul') . "'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
