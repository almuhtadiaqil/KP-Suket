...
if ($rows['gambar'] != '') {
  echo "Lihat Gambar : <a target='_BLANK' href='" . base_url() . "asset/foto_iklanatas/$rows[gambar]'>$rows[gambar]</a>";
}
echo "</td></tr>
                  </tbody>
                  </table>
              ...
              <div class='box-footer'>
                    ...
                    <a href='" . base_url('administrator/iklanatas') . "'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
