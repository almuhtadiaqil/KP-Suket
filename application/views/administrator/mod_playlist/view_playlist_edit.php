...
if ($rows['gbr_playlist'] != '') {
  echo " Gambar Saat ini : <a target='_BLANK' href='" . base_url() . "asset/img_playlist/$rows[gbr_playlist]'>$rows[gbr_playlist]</a>";
}
echo "</td></tr>
...
echo "</td></tr>
              ...
              <div class='box-footer'>
                    ...
                    <a href='" . base_url('administrator/playlist') . "'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
